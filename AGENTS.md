...
- **Triple density-jump RS+FS benchmark**: `scripts/benchmarks/triple_density_jump_rs_fs_tophat.py --mode formal` 使用 ASGARD/Vegas baseline top-hat 参数，固定 `jump_r_cm=(1e14,1e15,1e16) cm`、`jump_factor=1000`、`jump_width_log10=0.01`，输出 `output/asgard_doc/reverse_density_jump_tests/triple_density_jump_rs_fs_tophat.png` 的射电/光学/X 射线 FS+RS 光变。
