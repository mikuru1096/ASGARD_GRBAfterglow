subroutine dynamics_reverse(Delta_t,e_r,b_r,p_r,f_e_r,Boundary,n,Num_R, &
                            T_cross,R_cross,e3_cross,gam20,U3_cross,V3_cross,M3_cross,gam_m_cross, &
    ...
    real(8), intent(out) :: T_cross,R_cross,e3_cross,gam20,U3_cross,V3_cross,M3_cross,gam_m_cross
    ...
    real(8) :: u2_init,u4_init,Delta_init,para_n4_init,gam34_init,para_n3_init
    ...
    para_n3_init=(4d0*gam34_init+3d0)*para_n4_init
    ...
    do I_tobs=1,Num_R
        ...
        call dynamics_rk4_reverse(F,dB3,T_cross,R_cross,e3_cross,gam20,U3_cross,V3_cross,M3_cross, &
                                  gam_m_cross,T,H,Y,para_m_ej,Delta_0,eta_0,A_star,dNe_ISM, &
...
subroutine F(dB3,T_cross,R_cross,e3_cross,gam20,U3_cross,V3_cross,M3_cross,gam_m_cross, &
