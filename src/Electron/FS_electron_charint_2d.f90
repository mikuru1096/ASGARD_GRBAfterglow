subroutine fs_electron_charint_2d(Boundary,R_Tobs,R_Gamma,R,V_seed,n,Num_nu,Num_R,Num_gam_e, &
    ...
    call fs_electron_transport_2d_core_charint(Boundary,R_Tobs,R_Gamma,R,V_seed,n,Num_nu,Num_R,Num_gam_e, &
                                               Num_chi,index_Y,index_syn_intger,n_threads, &
                                               gam_e,dN_gam_e,dN_gam_e_total,P_syn,Seed_syn,V_m,V_c,V_a)

contains

subroutine fs_electron_transport_2d_core_charint(Boundary,R_Tobs,R_Gamma,R,V_seed,n,Num_nu,Num_R,Num_gam_e, &
                                                 Num_chi,index_Y,index_syn_intger,n_threads, &
                                                 gam_e,dN_gam_e,dN_gam_e_total,P_syn,Seed_syn,V_m,V_c,V_a)
    !$ use omp_lib
    use constants
    ...
    logical :: profile_enabled, magnetic_decay_active, use_charint_eta, use_charint_xi
    character(len=32) :: profile_env, profile_tag
    ...
    ln10 = dlog(ten)
    use_charint_eta = .true.
    use_charint_xi = .true.
    profile_tag = 'charint_2d'
...
end subroutine fs_electron_transport_2d_core_charint
