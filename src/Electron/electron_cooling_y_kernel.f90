...
module electron_cooling_y_kernel
  ...
  ! threadprivate(y_nakar_num_gam_cache,y_nakar_num_nu_cache,y_nakar_idx_cache,y_nakar_hat_nu_cache)
  ! threadprivate(y_nakar_prefix_cache,y_nakar_v_cache,y_nakar_vloc_cache,y_nakar_vg1,y_nakar_vg2)
  ! threadprivate(y_nakar_wg1,y_nakar_wg2)
