...
C            Bessel function of the first kind of order 0d0.
...
C 0d0 for double precision argument X.  The result is the Bessel
...
C$OMP THREADPRIVATE (NTI0,NTAI0,NTAI02,XSML,FIRST)
