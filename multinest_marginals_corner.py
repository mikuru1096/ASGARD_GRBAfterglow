...
for p, m in zip(parameters, s['marginals']):
	...
	truths=numpy.append(truths,med)
...
corner.corner(data[mask,:], weights=weights[mask], 
	labels=parameters, show_titles=True, quantiles=[0.16, 0.5, 0.84], plot_datapoints=False,
                        title_fmt=".2f", smooth=True, smooth1d=True, truths=truths,
                        color='#8869A5', truth_color='#8095CE', bins=30,)
