...
- `ASGARD/` — 外部用户 API: `api_model.py`, `api_observe.py`
...
- `src/Radiation/`: `radiation_common.f90`, `SSC_spec.f90`, `Annihilation.f90`, `Seed_reverse.f90`
- `src/Hadronic/`:
  - Entry: `FS_hadronic_1d.f90`
  - Kernels: `hadronic_common.f90`, `hadronic_transport_kernel.f90`, `hadronic_radiation_kernel.f90`, `hadronic_interaction_kernel.f90`, `hadronic_decay_kernel.f90`, `hadronic_pair_production_kernel.f90`, `hadronic_pp_kernel.f90`, `hadronic_bethe_heitler_kernel.f90`, `hadronic_hadronic_ic_kernel.f90`, `hadronic_species_transport_kernel.f90`, `hadronic_acceleration_kernel.f90`, `hadronic_secondary_radiation_kernel.f90`
- `src/Interpolation/`: `SED_interpolation.f90`, `SED_interpolation_structured.f90`, `interpolation_common.f90`

## Build Entrypoint

- `build_extensions.py` — f2py 编译入口。登记的 active hadronic extension: `FS_hadronic_1d`
