...
Reverse-shock dynamics baseline now uses local `gamma34` injection with explicit region-3 `U3/V3` thermal-state evolution; VegasAfterglow remains a comparison backend rather than a physics target.
