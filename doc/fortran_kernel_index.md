...
当前索引从 `src/**/*.f90`、`src/**/*.F90`、`src/**/*.f` 和 `src/**/*.F` 抽取，共 853 个程序单元：36 个 `module`、578 个 `subroutine`、239 个 `function`。行号是生成本页时的源文件位置。
...
### `src/Electron/slatec/d1mach.f`

SLATEC legacy fixed-form 特殊函数，服务 hybrid spectrum；修改前必须先证明现代替代完全等价。

| Kind | Line | Program unit | 算法/物理责任 |
| --- | ---: | --- | --- |
| `F` | 2 | `D1MACH` | SLATEC legacy 特殊函数；作为数学库依赖，不承载 ASGARD 物理分支。 |

### `src/Electron/slatec/d9gmic.f`

SLATEC legacy fixed-form 特殊函数，服务 hybrid spectrum；修改前必须先证明现代替代完全等价。

| Kind | Line | Program unit | 算法/物理责任 |
| --- | ---: | --- | --- |
| `F` | 2 | `D9GMIC` | SLATEC legacy 特殊函数；作为数学库依赖，不承载 ASGARD 物理分支。 |

### `src/Electron/slatec/d9gmit.f`

SLATEC legacy fixed-form 特殊函数，服务 hybrid spectrum；修改前必须先证明现代替代完全等价。

| Kind | Line | Program unit | 算法/物理责任 |
| --- | ---: | --- | --- |
| `F` | 2 | `D9GMIT` | SLATEC legacy 特殊函数；作为数学库依赖，不承载 ASGARD 物理分支。 |

### `src/Electron/slatec/d9lgic.f`

SLATEC legacy fixed-form 特殊函数，服务 hybrid spectrum；修改前必须先证明现代替代完全等价。

| Kind | Line | Program unit | 算法/物理责任 |
| --- | ---: | --- | --- |
| `F` | 2 | `D9LGIC` | SLATEC legacy 特殊函数；作为数学库依赖，不承载 ASGARD 物理分支。 |

### `src/Electron/slatec/d9lgit.f`

SLATEC legacy fixed-form 特殊函数，服务 hybrid spectrum；修改前必须先证明现代替代完全等价。

| Kind | Line | Program unit | 算法/物理责任 |
| --- | ---: | --- | --- |
| `F` | 2 | `D9LGIT` | SLATEC legacy 特殊函数；作为数学库依赖，不承载 ASGARD 物理分支。 |

### `src/Electron/slatec/d9lgmc.f`

SLATEC legacy fixed-form 特殊函数，服务 hybrid spectrum；修改前必须先证明现代替代完全等价。

| Kind | Line | Program unit | 算法/物理责任 |
| --- | ---: | --- | --- |
| `F` | 2 | `D9LGMC` | SLATEC legacy 特殊函数；作为数学库依赖，不承载 ASGARD 物理分支。 |

### `src/Electron/slatec/dasyik.f`

SLATEC legacy fixed-form 特殊函数，服务 hybrid spectrum；修改前必须先证明现代替代完全等价。

| Kind | Line | Program unit | 算法/物理责任 |
| --- | ---: | --- | --- |
| `S` | 2 | `DASYIK` | SLATEC legacy 特殊函数；作为数学库依赖，不承载 ASGARD 物理分支。 |

### `src/Electron/slatec/dbesi0.f`

SLATEC legacy fixed-form 特殊函数，服务 hybrid spectrum；修改前必须先证明现代替代完全等价。

| Kind | Line | Program unit | 算法/物理责任 |
| --- | ---: | --- | --- |
| `F` | 2 | `DBESI0` | SLATEC legacy 特殊函数；作为数学库依赖，不承载 ASGARD 物理分支。 |

### `src/Electron/slatec/dbesi1.f`

SLATEC legacy fixed-form 特殊函数，服务 hybrid spectrum；修改前必须先证明现代替代完全等价。

| Kind | Line | Program unit | 算法/物理责任 |
| --- | ---: | --- | --- |
| `F` | 2 | `DBESI1` | SLATEC legacy 特殊函数；作为数学库依赖，不承载 ASGARD 物理分支。 |

### `src/Electron/slatec/dbesk.f`

SLATEC legacy fixed-form 特殊函数，服务 hybrid spectrum；修改前必须先证明现代替代完全等价。

| Kind | Line | Program unit | 算法/物理责任 |
| --- | ---: | --- | --- |
| `S` | 2 | `DBESK` | SLATEC legacy 特殊函数；作为数学库依赖，不承载 ASGARD 物理分支。 |

### `src/Electron/slatec/dbesk0.f`

SLATEC legacy fixed-form 特殊函数，服务 hybrid spectrum；修改前必须先证明现代替代完全等价。

| Kind | Line | Program unit | 算法/物理责任 |
| --- | ---: | --- | --- |
| `F` | 2 | `DBESK0` | SLATEC legacy 特殊函数；作为数学库依赖，不承载 ASGARD 物理分支。 |

### `src/Electron/slatec/dbesk1.f`

SLATEC legacy fixed-form 特殊函数，服务 hybrid spectrum；修改前必须先证明现代替代完全等价。

| Kind | Line | Program unit | 算法/物理责任 |
| --- | ---: | --- | --- |
| `F` | 2 | `DBESK1` | SLATEC legacy 特殊函数；作为数学库依赖，不承载 ASGARD 物理分支。 |

### `src/Electron/slatec/dbsi0e.f`

SLATEC legacy fixed-form 特殊函数，服务 hybrid spectrum；修改前必须先证明现代替代完全等价。

| Kind | Line | Program unit | 算法/物理责任 |
| --- | ---: | --- | --- |
| `F` | 2 | `DBSI0E` | SLATEC legacy 特殊函数；作为数学库依赖，不承载 ASGARD 物理分支。 |

### `src/Electron/slatec/dbsi1e.f`

SLATEC legacy fixed-form 特殊函数，服务 hybrid spectrum；修改前必须先证明现代替代完全等价。

| Kind | Line | Program unit | 算法/物理责任 |
| --- | ---: | --- | --- |
| `F` | 2 | `DBSI1E` | SLATEC legacy 特殊函数；作为数学库依赖，不承载 ASGARD 物理分支。 |

### `src/Electron/slatec/dbsk0e.f`

SLATEC legacy fixed-form 特殊函数，服务 hybrid spectrum；修改前必须先证明现代替代完全等价。

| Kind | Line | Program unit | 算法/物理责任 |
| --- | ---: | --- | --- |
| `F` | 2 | `DBSK0E` | SLATEC legacy 特殊函数；作为数学库依赖，不承载 ASGARD 物理分支。 |

### `src/Electron/slatec/dbsk1e.f`

SLATEC legacy fixed-form 特殊函数，服务 hybrid spectrum；修改前必须先证明现代替代完全等价。

| Kind | Line | Program unit | 算法/物理责任 |
| --- | ---: | --- | --- |
| `F` | 2 | `DBSK1E` | SLATEC legacy 特殊函数；作为数学库依赖，不承载 ASGARD 物理分支。 |

### `src/Electron/slatec/dbsknu.f`

SLATEC legacy fixed-form 特殊函数，服务 hybrid spectrum；修改前必须先证明现代替代完全等价。

| Kind | Line | Program unit | 算法/物理责任 |
| --- | ---: | --- | --- |
| `S` | 2 | `DBSKNU` | SLATEC legacy 特殊函数；作为数学库依赖，不承载 ASGARD 物理分支。 |

### `src/Electron/slatec/dcsevl.f`

SLATEC legacy fixed-form 特殊函数，服务 hybrid spectrum；修改前必须先证明现代替代完全等价。

| Kind | Line | Program unit | 算法/物理责任 |
| --- | ---: | --- | --- |
| `F` | 2 | `DCSEVL` | SLATEC legacy 特殊函数；作为数学库依赖，不承载 ASGARD 物理分支。 |

### `src/Electron/slatec/dgamic.f`

SLATEC legacy fixed-form 特殊函数，服务 hybrid spectrum；修改前必须先证明现代替代完全等价。

| Kind | Line | Program unit | 算法/物理责任 |
| --- | ---: | --- | --- |
| `F` | 2 | `DGAMIC` | SLATEC legacy 特殊函数；作为数学库依赖，不承载 ASGARD 物理分支。 |

### `src/Electron/slatec/dgamlm.f`

SLATEC legacy fixed-form 特殊函数，服务 hybrid spectrum；修改前必须先证明现代替代完全等价。

| Kind | Line | Program unit | 算法/物理责任 |
| --- | ---: | --- | --- |
| `S` | 2 | `DGAMLM` | SLATEC legacy 特殊函数；作为数学库依赖，不承载 ASGARD 物理分支。 |

### `src/Electron/slatec/dgamma.f`

SLATEC legacy fixed-form 特殊函数，服务 hybrid spectrum；修改前必须先证明现代替代完全等价。

| Kind | Line | Program unit | 算法/物理责任 |
| --- | ---: | --- | --- |
| `F` | 2 | `DGAMMA` | SLATEC legacy 特殊函数；作为数学库依赖，不承载 ASGARD 物理分支。 |

### `src/Electron/slatec/dlamch.f`

SLATEC legacy fixed-form 特殊函数，服务 hybrid spectrum；修改前必须先证明现代替代完全等价。

| Kind | Line | Program unit | 算法/物理责任 |
| --- | ---: | --- | --- |
| `F` | 68 | `DLAMCH` | SLATEC legacy 特殊函数；作为数学库依赖，不承载 ASGARD 物理分支。 |
| `F` | 171 | `DLAMC3` | SLATEC legacy 特殊函数；作为数学库依赖，不承载 ASGARD 物理分支。 |

### `src/Electron/slatec/dlgams.f`

SLATEC legacy fixed-form 特殊函数，服务 hybrid spectrum；修改前必须先证明现代替代完全等价。

| Kind | Line | Program unit | 算法/物理责任 |
| --- | ---: | --- | --- |
| `S` | 2 | `DLGAMS` | SLATEC legacy 特殊函数；作为数学库依赖，不承载 ASGARD 物理分支。 |

### `src/Electron/slatec/dlngam.f`

SLATEC legacy fixed-form 特殊函数，服务 hybrid spectrum；修改前必须先证明现代替代完全等价。

| Kind | Line | Program unit | 算法/物理责任 |
| --- | ---: | --- | --- |
| `F` | 2 | `DLNGAM` | SLATEC legacy 特殊函数；作为数学库依赖，不承载 ASGARD 物理分支。 |

### `src/Electron/slatec/fdump.f`

SLATEC legacy fixed-form 特殊函数，服务 hybrid spectrum；修改前必须先证明现代替代完全等价。

| Kind | Line | Program unit | 算法/物理责任 |
| --- | ---: | --- | --- |
| `S` | 2 | `FDUMP` | SLATEC legacy 特殊函数；作为数学库依赖，不承载 ASGARD 物理分支。 |

### `src/Electron/slatec/i1mach.f`

SLATEC legacy fixed-form 特殊函数，服务 hybrid spectrum；修改前必须先证明现代替代完全等价。

| Kind | Line | Program unit | 算法/物理责任 |
| --- | ---: | --- | --- |
| `F` | 2 | `I1MACH` | SLATEC legacy 特殊函数；作为数学库依赖，不承载 ASGARD 物理分支。 |

### `src/Electron/slatec/initds.f`

SLATEC legacy fixed-form 特殊函数，服务 hybrid spectrum；修改前必须先证明现代替代完全等价。

| Kind | Line | Program unit | 算法/物理责任 |
| --- | ---: | --- | --- |
| `F` | 2 | `INITDS` | SLATEC legacy 特殊函数；作为数学库依赖，不承载 ASGARD 物理分支。 |

### `src/Electron/slatec/j4save.f`

SLATEC legacy fixed-form 特殊函数，服务 hybrid spectrum；修改前必须先证明现代替代完全等价。

| Kind | Line | Program unit | 算法/物理责任 |
| --- | ---: | --- | --- |
| `F` | 2 | `J4SAVE` | SLATEC legacy 特殊函数；作为数学库依赖，不承载 ASGARD 物理分支。 |

### `src/Electron/slatec/lsame.f`

SLATEC legacy fixed-form 特殊函数，服务 hybrid spectrum；修改前必须先证明现代替代完全等价。

| Kind | Line | Program unit | 算法/物理责任 |
| --- | ---: | --- | --- |
| `F` | 2 | `LSAME` | SLATEC legacy 特殊函数；作为数学库依赖，不承载 ASGARD 物理分支。 |

### `src/Electron/slatec/specfun.f90`

SLATEC legacy fixed-form 特殊函数，服务 hybrid spectrum；修改前必须先证明现代替代完全等价。

| Kind | Line | Program unit | 算法/物理责任 |
| --- | ---: | --- | --- |
| `M` | 1 | `specfun` | 模块命名空间；集中声明本文件共享 procedure。 |
| `F` | 10 | `dgamic` | SLATEC legacy 特殊函数；作为数学库依赖，不承载 ASGARD 物理分支。 |
| `F` | 15 | `dbesk0` | SLATEC legacy 特殊函数；作为数学库依赖，不承载 ASGARD 物理分支。 |
| `F` | 20 | `dbesk1` | SLATEC legacy 特殊函数；作为数学库依赖，不承载 ASGARD 物理分支。 |
| `F` | 28 | `gammauic` | SLATEC legacy 特殊函数；作为数学库依赖，不承载 ASGARD 物理分支。 |
| `F` | 36 | `besselk` | SLATEC legacy 特殊函数；作为数学库依赖，不承载 ASGARD 物理分支。 |
| `F` | 54 | `besselk0` | SLATEC legacy 特殊函数；作为数学库依赖，不承载 ASGARD 物理分支。 |
| `F` | 63 | `besselk1` | SLATEC legacy 特殊函数；作为数学库依赖，不承载 ASGARD 物理分支。 |

### `src/Electron/slatec/xerclr.f`

SLATEC legacy fixed-form 特殊函数，服务 hybrid spectrum；修改前必须先证明现代替代完全等价。

| Kind | Line | Program unit | 算法/物理责任 |
| --- | ---: | --- | --- |
| `S` | 2 | `XERCLR` | SLATEC legacy 特殊函数；作为数学库依赖，不承载 ASGARD 物理分支。 |

### `src/Electron/slatec/xercnt.f`

SLATEC legacy fixed-form 特殊函数，服务 hybrid spectrum；修改前必须先证明现代替代完全等价。

| Kind | Line | Program unit | 算法/物理责任 |
| --- | ---: | --- | --- |
| `S` | 2 | `XERCNT` | SLATEC legacy 特殊函数；作为数学库依赖，不承载 ASGARD 物理分支。 |

### `src/Electron/slatec/xerhlt.f`

SLATEC legacy fixed-form 特殊函数，服务 hybrid spectrum；修改前必须先证明现代替代完全等价。

| Kind | Line | Program unit | 算法/物理责任 |
| --- | ---: | --- | --- |
| `S` | 2 | `XERHLT` | SLATEC legacy 特殊函数；作为数学库依赖，不承载 ASGARD 物理分支。 |

### `src/Electron/slatec/xermsg.f`

SLATEC legacy fixed-form 特殊函数，服务 hybrid spectrum；修改前必须先证明现代替代完全等价。

| Kind | Line | Program unit | 算法/物理责任 |
| --- | ---: | --- | --- |
| `S` | 2 | `XERMSG` | SLATEC legacy 特殊函数；作为数学库依赖，不承载 ASGARD 物理分支。 |

### `src/Electron/slatec/xerprn.f`

SLATEC legacy fixed-form 特殊函数，服务 hybrid spectrum；修改前必须先证明现代替代完全等价。

| Kind | Line | Program unit | 算法/物理责任 |
| --- | ---: | --- | --- |
| `S` | 2 | `XERPRN` | SLATEC legacy 特殊函数；作为数学库依赖，不承载 ASGARD 物理分支。 |

### `src/Electron/slatec/xersve.f`

SLATEC legacy fixed-form 特殊函数，服务 hybrid spectrum；修改前必须先证明现代替代完全等价。

| Kind | Line | Program unit | 算法/物理责任 |
| --- | ---: | --- | --- |
| `S` | 2 | `XERSVE` | SLATEC legacy 特殊函数；作为数学库依赖，不承载 ASGARD 物理分支。 |

### `src/Electron/slatec/xgetua.f`

SLATEC legacy fixed-form 特殊函数，服务 hybrid spectrum；修改前必须先证明现代替代完全等价。

| Kind | Line | Program unit | 算法/物理责任 |
| --- | ---: | --- | --- |
| `S` | 2 | `XGETUA` | SLATEC legacy 特殊函数；作为数学库依赖，不承载 ASGARD 物理分支。 |
